...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label welcomeLabel = new Label("Welcome to vector Quantization Compressor");
...
//        scaleButtonAndLabel(compressButton);
        ...
        compressButton.setOnAction(event -> {
            ...
            Controller c = new Controller(new ReadWriteImage(),
                    new VectorQuantization(2));
            try {
                c.CompressImage(inputFileName, "I:\\VSprojects\\ProjectsOfThirdYear\\DataCom\\CompressedImage.png", 16);
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
//            c.(inputFileName, "I:\\VSprojects\\ProjectsOfThirdYear\\DataCom\\Compressed.bin");
...
//        });
        ...
        buttonsContainer.getChildren().addAll(compressButton);
